...
| Date | Title | Audience | Tags |
|------|-------|----------|------|
| 2026-09-25 | [Claims Copilot Agent — Phased Roadmap System Design](articles/2026-09-25-claims-copilot-agent-phased-roadmap.md) · [中文](articles/2026-09-25-claims-copilot-agent-phased-roadmap.zh.md) | Architects, Claims engineers, Security, Hiring | `architecture` `claims` `agent` `mcp` `hitl` `evaluation` `design-patterns` |
| 2026-09-25 | [Golden Pit Opportunity Radar — Phased Roadmap](articles/2026-09-25-golden-pit-opportunity-radar-phased-roadmap.md) · [中文](articles/2026-09-25-golden-pit-opportunity-radar-phased-roadmap.zh.md) | Invest AI engineers, Product, Report consumers | `architecture` `invest-ai` `golden-pit` `worker-cache` `adr-041` `design-patterns` |
| 2026-09-25 | [Agent Firewall — Phased Roadmap](articles/2026-09-25-agent-firewall-phased-roadmap.md) · [中文](articles/2026-09-25-agent-firewall-phased-roadmap.zh.md) | Agent platform, Security, Local AI coding ops | `architecture` `agent-firewall` `policy` `hitl` `ledger` `design-patterns` |
| 2026-09-25 | [XNP Phase 3+ Next — Phased Roadmap](articles/2026-09-25-xnp-phase-3-next-phased-roadmap.md) · [中文](articles/2026-09-25-xnp-phase-3-next-phased-roadmap.zh.md) | Platform Architects, .NET engineers, Security | `architecture` `xnp` `notifications` `consent` `modular-monolith` `design-patterns` |
| 2026-08-05 | [Invest Lab Feedback Loop: Paper Evidence Before Any Draft](articles/2026-08-05-invest-lab-feedback-loop-invest-ai-sim-mcp.md) · [中文](articles/2026-08-05-invest-lab-feedback-loop-invest-ai-sim-mcp.zh.md) | Architects, Lab ops, MCP security reviewers, Product | `architecture` `invest-ai` `investsim` `mcp` `robinhood` `paper-trading` `worker-cache` `design-patterns` |
| 2026-08-04 | [Daily Investment Zhibao: Worker-Owned Chinese PDF Inside Invest AI](articles/2026-08-04-daily-investment-zhibao-worker-pipeline.md) · [中文](articles/2026-08-04-daily-investment-zhibao-worker-pipeline.zh.md) | Product / Ops, Architects, Worker Engineers | `architecture` `invest-ai` `reporting` `worker-cache` `pdf` `resend` `design-patterns` |
| 2026-08-04 | [Evidence Honesty Stack: Overlays, PDF Bibliography, Citation Dates](articles/2026-08-04-evidence-honesty-overlay-pdf-citation-dates.md) · [中文](articles/2026-08-04-evidence-honesty-overlay-pdf-citation-dates.zh.md) | Architects, Research leads, Eval / CI, Security | `architecture` `evidence` `provenance` `worker-cache` `governance` `pdf` `design-patterns` |
| 2026-08-04 | [XNP Phase 2 Foundation: Modular Monolith That Boots Empty](articles/2026-08-04-xnp-phase-2-foundation-system-design.md) · [中文](articles/2026-08-04-xnp-phase-2-foundation-system-design.zh.md) | Platform Architects, .NET Engineers, Security | `architecture` `xnp` `notifications` `modular-monolith` `postgres` `outbox` `design-patterns` |
| 2026-07-26 | [Evidence Engine + Eval Registry: Citation Verification with an EEE Gate](articles/2026-07-26-evidence-engine-eval-registry.md) · [中文](articles/2026-07-26-evidence-engine-eval-registry.zh.md) | Enterprise Architects, AI Architects, Platform / CI, Security | `architecture` `enterprise` `evidence` `evaluation` `eee` `worker-cache` `governance` `design-patterns` |
| 2026-07-17 | [LLM App Guardrails: Plan → Build → Validate → Operate Is Not a Tool Catalog](articles/2026-07-17-llm-app-guardrails-plan-build-validate-operate.md) · [中文](articles/2026-07-17-llm-app-guardrails-plan-build-validate-operate.zh.md) | Enterprise Architects, AI Architects, Platform Engineers, Security | `architecture` `enterprise` `guardrails` `monitoring` `mcp` `rag` `governance` `education` `design-patterns` |
| 2026-07-16 | [Skill Curricula Beat Random AI Drills: Workplace Communication as a Decision Loop](articles/2026-07-16-skill-curricula-beat-random-ai-drills.md) · [中文](articles/2026-07-16-skill-curricula-beat-random-ai-drills.zh.md) | Enterprise Architects, L&D / AI Product Leads, Curriculum Authors | `architecture` `enterprise` `education` `decision-ledger` `curriculum` `workplace-ai` `agents` `design-patterns` |
