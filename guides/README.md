...
> **Moved:** *From Toy Demo to Enterprise AI Agent* now sits with the other domain courses at [`../courses/toy-demo-to-enterprise-agent/`](../courses/toy-demo-to-enterprise-agent/README.md) · [中文](../courses/toy-demo-to-enterprise-agent/README.zh.md).
